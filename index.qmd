...
# INDICCE DE DESARROLLO HUMANO (IDH)
...
# UNION DE CANTONES E INDICES

# crear unión de cantones e índices
cantones_indices <-
  cantones |>
  left_join(
    idh,
...
Densidad_población <- rast("Densidad_población.tif")

```

# Indice de Desarrollo Humano (IDH) 2022
...
mapa <-
  ...
  # Densidad de población
  tm_shape(Densidad_población, name = "Densidad de población")+
  tm_raster(
     style  = "quantile",
